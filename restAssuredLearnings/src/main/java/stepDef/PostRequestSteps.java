...
public class PostRequestSteps extends BaseClass {
	
TestContextAPI testContext;
	
	public PostRequestSteps(TestContextAPI testContext) {
	...
	public void i_set_header_and_body_to_create_new_user() {
				...
				hm_header.putIfAbsent("Content-Type", "application/json");
	...
	@Then("API created a user in the system")
	public void api_created_a_user_in_the_system() {
